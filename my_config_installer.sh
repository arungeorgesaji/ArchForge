...
yay -S linux-wifi-hotspot yaycache autojump picom-git python39 python310 trash-cli wireshark-git ms-365-electron-bin conda epson-printer-utility fastfetch-git postman-bin ani-cli debtap
